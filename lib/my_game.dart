...
import 'package:dragon_game/helper/enums.dart';
import 'package:dragon_game/helper/game_controller.dart';
import 'package:dragon_game/helper/preference_helper.dart';
import 'package:dragon_game/widgets/player.dart';
import 'package:dragon_game/widgets/responsive/responsive.dart';
                  ...
                  return Material(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "${'score'.tr}: ${GetIt.instance<GameController>().coinsCollected.value}",
                          style: const TextStyle(
                            color: Colors.black,
                            fontFamily: "Bungee",
                            fontSize: 24,
...
class RunGame extends FlameGame with HasCollisionDetection, TapDetector {
